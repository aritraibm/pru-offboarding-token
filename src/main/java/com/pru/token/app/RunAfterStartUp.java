...
public class RunAfterStartUp {
	...
	public void runAfterStartup() {
		...
		// Manager user
		if(!userRepository.findByEmail("Manideep.siripalli@ibm.com").isPresent()) {
			...
			RequestUser requestUserManager = new RequestUser("Manideep.siripalli@ibm.com", "987654", reviewer.getEmpId(), manager.getEmpId(),
